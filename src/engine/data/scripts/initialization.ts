...
export function initialization(): Script {
    ...
    function setupUI() {
        return [
            ...
            UIPrimaryMetricValue.set(
                Add(screenLeft, 0.05, Multiply(0.715, UIPrimaryMetricConfiguration.scale)),
            ...
            UISecondaryMetricBar.set(
                Subtract(screenRight, 0.1, Multiply(0.15, UIMenuConfiguration.scale)),
                0.95,
                1,
                1,
    ...
    function setupBuckets() {
        return [
            ...
            LevelBucket.of(buckets.leftDirectionalFlickNoteIndex).setBucket(50, 100, 150),
            LevelBucket.of(buckets.rightDirectionalFlickNoteIndex).setBucket(50, 100, 150),
            LevelBucket.of(buckets.slideStartNoteIndex).setBucket(50, 100, 150),
            If(
                options.isStrictJudgment,
                [
                    LevelBucket.of(buckets.slideTickNoteIndex).setBucket(0, 50, 0, 100, 0, 150),
                    LevelBucket.of(buckets.slideEndNoteIndex).setBucket(50, 100, 150),
                    LevelBucket.of(buckets.slideFlickNoteIndex).setBucket(50, 100, 150),
                ],
                [
                    LevelBucket.of(buckets.slideTickNoteIndex).setBucket(0, 200, 0, 200, 0, 200),
    ...
    function setupLife() {
        return [
            ArchetypeLife.of(archetypes.tapNoteIndex).missLifeIncrement.set(-100),
            ArchetypeLife.of(archetypes.flickNoteIndex).missLifeIncrement.set(-100),
            ArchetypeLife.of(archetypes.directionalFlickNoteIndex).missLifeIncrement.set(-100),
            ArchetypeLife.of(archetypes.slideStartNoteIndex).missLifeIncrement.set(-100),
            ArchetypeLife.of(archetypes.slideTickNoteIndex).missLifeIncrement.set(-20),
            ArchetypeLife.of(archetypes.slideEndNoteIndex).missLifeIncrement.set(-100),
            ArchetypeLife.of(archetypes.slideFlickNoteIndex).missLifeIncrement.set(-100),
        ]
    }
}
